...
void UpdateList(GameInfo &newGameInfo, Node* &pHead){
    pHead->theGameInfo.personRoom = newGameInfo.personRoom;
    pHead->theGameInfo.wumpusRoom = newGameInfo.wumpusRoom;
    pHead->theGameInfo.pitRoom1 = newGameInfo.pitRoom1;
    pHead->theGameInfo.pitRoom2 = newGameInfo.pitRoom2;
    pHead->theGameInfo.batsRoom1 = newGameInfo.batsRoom1;
    pHead->theGameInfo.batsRoom2 = newGameInfo.batsRoom2;
    pHead->theGameInfo.arrowRoom = newGameInfo.arrowRoom;
}

void AddToList(GameInfo &newGameInfo, Node* &pHead){
    //Make a new node - temp
    Node* pTemp = new Node;
  
    // cout << pHead->theGameInfo.personRoom;
    //Initialize the new node - also the next part
    pTemp->theGameInfo.personRoom = newGameInfo.personRoom;
    pTemp->theGameInfo.wumpusRoom = newGameInfo.wumpusRoom;
    pTemp->theGameInfo.pitRoom1 = newGameInfo.pitRoom1;
    pTemp->theGameInfo.pitRoom2 = newGameInfo.pitRoom2;
    pTemp->theGameInfo.batsRoom1 = newGameInfo.batsRoom1;
    pTemp->theGameInfo.batsRoom2 = newGameInfo.batsRoom2;
    pTemp->theGameInfo.arrowRoom = newGameInfo.arrowRoom;
    pTemp->pNext = NULL;
    
    //make the node a part of the list
    if(pHead == NULL){ // Empty
        pHead = pTemp; 
    }
    else{ //NotEmpty
...
void Undo( GameInfo &newGameInfo, Node* &pHead){
    
    if(newGameInfo.moveNumber == 1){
        ...
        //reset with pCurrentNode values;
        // cout << pHead->theGameInfo.personRoom;
        newGameInfo.personRoom = pHead->pNext->theGameInfo.personRoom;
        newGameInfo.wumpusRoom = pHead->pNext->theGameInfo.wumpusRoom;
        newGameInfo.pitRoom1 = pHead->pNext->theGameInfo.pitRoom1;
        newGameInfo.pitRoom2 = pHead->pNext->theGameInfo.pitRoom2;
        newGameInfo.batsRoom1 = pHead->pNext->theGameInfo.batsRoom1; 
        newGameInfo.batsRoom2 = pHead->pNext->theGameInfo.batsRoom2;
        newGameInfo.arrowRoom = pHead->pNext->theGameInfo.arrowRoom;

        // Update pHead
        pHead = pHead->pNext;
        newGameInfo.moveNumber--;
    }
}
